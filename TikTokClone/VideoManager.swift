...
//  TikTokClone
//
//  Created by Azmat Ali Akhtar on 26/04/2023.
//
...
class VideoManager: ObservableObject {
    ...
    func findVideos(topic: Query) async {
        ...
        urlRequest.setValue("rfIZVkd6khNsqta9BU6Y6ZcNiwqatyV5z0zXBIq7Bchs7ixAmV3MX7OQ", forHTTPHeaderField: "Authorization")
